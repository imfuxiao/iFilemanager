...
struct FileWebRouteCollection: RouteCollection {
    let rootDocumentDirectory: URL = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0]
    // #available(iOS 15, *)
    // let rootDocumentDirectory = URL.documentsDirectory
    ...
    func raw(_ req: Request) throws -> Response {
        ...
        if let fileNames = fileNames {
            ...
            for fileName in fileNames.components(separatedBy: ",") {
                let fileURL = rootDocumentDirectory
